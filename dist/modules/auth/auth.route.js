...
authRoutes.post("/login", rateLimiter_1.rateLimiter, auth_module_1.authController.login);
authRoutes.post("/verify/email", auth_module_1.authController.verifyEmail);
authRoutes.post("/verify/resend-email", auth_module_1.authController.resendVerifyEmail);
