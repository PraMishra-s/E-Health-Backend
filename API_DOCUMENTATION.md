...
Example:
Post-login cookies:Set-Cookie: accessToken=<jwt-token>; HttpOnly; Path=/; Expires=<date>
Set-Cookie: refreshToken=<refresh-token>; HttpOnly; Path=/api/v1/auth/refresh; Expires=<date>


Request:curl -X POST /api/v1/notification/create -b "accessToken=<jwt-token>"
...
Example curl:curl -X POST /api/v1/auth/register \
...
Example curl:curl -X POST /api/v1/auth/login \
  -H "Content-Type: application/json" \
...
Example curl:curl -X POST /api/v1/auth/refresh \
...
Example curl:curl -X POST /api/v1/auth/logout \
...
/api/v1/feed/create
Creates a feed post
authenticateJWT, HA only
None


PUT
/api/v1/feed/update/:id
Updates a feed post
authenticateJWT, HA only
None
...
DELETE
/api/v1/feed/deleteAll/all
Deletes all feed posts
authenticateJWT, HA only
None
...
Example curl:curl -X POST /api/v1/feed/create \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
Example curl:curl -X DELETE /api/v1/feed/deleteAll/all \
  -b "accessToken=<jwt-token>"
...
PUT
/api/v1/ha/update
Updates HA secret key
authenticateJWT, HA only
None


PUT
/api/v1/ha/toggle-availability
Toggles HA availability
authenticateJWT, HA only
None
...
GET
/api/v1/ha/get-leave
Retrieves HA leave details
authenticateJWT, HA only
None


GET
/api/v1/ha/get-ha-details
Retrieves HA profile
authenticateJWT, HA only
None


PUT
/api/v1/ha/change-status/:id
Updates HA status
authenticateJWT, HA only
None
...
Example curl:curl -X PUT /api/v1/ha/change-status/123e4567-e89b-12d3-a456-426614174000 \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
  -d '{"status":"AVAILABLE"}'
...
Example curl:curl -X GET /api/v1/ha_dashboard \
  -b "accessToken=<jwt-token>"
...
GET
/api/v1/mental-cases
Retrieves mental health cases
authenticateJWT, DEAN only
None


PUT
/api/v1/mental-cases/update/:id
Updates a mental health case
authenticateJWT, DEAN only
None
...
Example curl:curl -X GET /api/v1/mental-cases \
  -b "accessToken=<jwt-token>"
...
POST
/api/v1/illness_category/create
Creates an illness category
authenticateJWT, HA only
None


GET
/api/v1/illness_category
Retrieves all illness categories
authenticateJWT, HA only
None


PUT
/api/v1/illness_category/update/:id
Updates an illness category
authenticateJWT, HA only
None


DELETE
/api/v1/illness_category/delete/:id
Deletes an illness category
authenticateJWT, HA only
None
...
Example curl:curl -X POST /api/v1/illness_category/create \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
  -d '{"name":"Respiratory"}'
...
Example curl:curl -X DELETE /api/v1/illness_category/delete/123e4567-e89b-12d3-a456-426614174008 \
  -b "accessToken=<jwt-token>"
...
GET
/api/v1/illness/:id
Retrieves an illness by ID
None
None


PUT
/api/v1/illness/update/:id
Updates an illness
authenticateJWT, HA only
None
...
Example curl:curl -X POST /api/v1/illness/create \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
Example curl:curl -X POST /api/v1/notification/create \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
POST
/api/v1/staff-family/create
Creates a family member
authenticateJWT, STAFF or HA
None


GET
/api/v1/staff-family/:staff_id
Retrieves active family members
authenticateJWT, STAFF or HA
None


GET
/api/v1/staff-family/all/:staff_id
...
DELETE
/api/v1/staff-family/hard-delete/:id
Hard-deletes a family member
authenticateJWT, STAFF or HA
None
...
Example curl:curl -X POST /api/v1/staff-family/create \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
Example curl:curl -X GET /api/v1/staff-family/123e4567-e89b-12d3-a456-426614174001 \
  -b "accessToken=<jwt-token>"
...
Example curl:curl -X GET /api/v1/staff-family/all/123e4567-e89b-12d3-a456-426614174001 \
  -b "accessToken=<jwt-token>"
...
POST
/api/v1/inventory/categories/add
Creates a medicine category
authenticateJWT, HA only
None
...
GET
/api/v1/inventory/categories/counts
...
GET
/api/v1/inventory/medicines-expired
...
POST
/api/v1/inventory/transactions/add
...
POST
/api/v1/inventory/transactions/use
Uses medicine for a patient
authenticateJWT, HA only
None


POST
/api/v1/inventory/transactions/remove
Removes stock
authenticateJWT, HA only
None
...
GET
/api/v1/inventory/medicine/batch/:id
...
GET
/api/v1/inventory/medicine/batch
...
PUT
/api/v1/inventory/medicine/batch/update/:id
Updates a batch
authenticateJWT, HA only
None
...
DELETE
/api/v1/inventory/medicine/batch/delete/:id
Deletes a batch
authenticateJWT, HA only
None
...
DELETE
/api/v1/inventory/medicine/batch/expired/delete/:id
Deletes an expired batch
authenticateJWT, HA only
None
...
Example curl:curl -X POST /api/v1/inventory/medicines \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
Retrieves patient treatments
authenticateJWT
None


GET
/api/v1/treatment/individual/:id
...
GET
/api/v1/treatment/students
Retrieves student treatments
authenticateJWT, STAFF/DEAN/HA only
None
...
Example curl:curl -X POST /api/v1/treatment/create \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
Example curl:curl -X GET /api/v1/treatment/patient/123e4567-e89b-12d3-a456-426614174002 \
  -b "accessToken=<jwt-token>"
...
Example curl:curl -X POST /api/v1/mfa/invoke \
  -b "accessToken=<jwt-token>"
...
Example curl:curl -X POST /api/v1/mfa/verify-login \
  -H "Content-Type: application/json" \
...
Example curl:curl -X PUT /api/v1/mfa/revoke \
  -b "accessToken=<jwt-token>"
...
Example curl:curl -X GET /api/v1/session \
  -b "accessToken=<jwt-token>"
...
Example curl:curl -X GET /api/v1/session/all \
  -b "accessToken=<jwt-token>"
...
Example curl:curl -X DELETE /api/v1/session/f2664a0f-81fb-41de-98b7-ba1a714c60a5 \
  -b "accessToken=<jwt-token>"
...
Example curl:curl -X DELETE /api/v1/session/delete/all \
  -b "accessToken=<jwt-token>"
...
POST
/api/v1/users/email
Checks email availability or initiates password reset
None
None
...
GET
/api/v1/users/programmes
Retrieves academic programs
authenticateJWT
None


PUT
/api/v1/users/change-userType/:id
Changes user type
authenticateJWT
None
...
GET
/api/v1/users/getStaff
Retrieves staff users
authenticateJWT
None
...
Example curl:curl -X PUT /api/v1/users/update \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
Example curl:curl -X POST /api/v1/users/email \
  -H "Content-Type: application/json" \
...
Example curl:curl -X PUT /api/v1/users/change-password \
  -H "Content-Type: application/json" \
  -b "accessToken=<jwt-token>" \
...
Example curl:curl -X GET /api/v1/users/programmes \
  -b "accessToken=<jwt-token>"
...
POST /api/v1/auth/register requires email domain *.cst@rub.edu.bt.
